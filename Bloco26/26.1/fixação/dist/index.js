...
console.log(`Losango de Diagonal maior 4 e diagonal menor 2: ${Exercise.losango(78, 2)}`);
console.log(`trapezio de B = 100cm, b = 70cm e altura = 50cm: ${Exercise.trapezio(100, 70, 50)}`);
